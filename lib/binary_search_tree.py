"""
    Classe que representa cada unidade (elemento) da árvore binaria de busca
...
class BinarySearchTree:
    ...
    def insert(self, val):
        ...
        # Exibe a árvore (tasco, para debug)
        print('[ÁRVORE] data: {self.__root.data}, left: {self.__root.left}, right: {self.__root.right}' )

    """
        Método __privado para inserção de um nodo na árvore
    """
    def __insert_node(self, node, root):
        # 1º caso: valor do nodo é menor que o valor da raiz -> val para a ESQUERDA
