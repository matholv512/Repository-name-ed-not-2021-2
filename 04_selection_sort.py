...
# encontra o menor valor no restante da lista. Se o maior encontrado
...
# se necessário. Continua o processo, até isolar o penultimo elemento
# da lista.
...
# NÂO é o pior caso: lista em ordem inversa
